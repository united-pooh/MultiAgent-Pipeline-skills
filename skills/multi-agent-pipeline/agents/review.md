...
- The installed Playwright skill path when browser automation is required for validation
...
- If browser behavior is required to evaluate correctness or regressions, read the provided Playwright skill path first and follow that skill in a read-only validation mode. Do not edit repo files as part of browser validation.
