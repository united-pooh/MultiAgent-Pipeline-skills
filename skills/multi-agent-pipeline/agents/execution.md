...
- If real browser validation is required to satisfy the spec, regressions, or review feedback, read the provided Playwright skill path first and follow that skill's CLI-first workflow.
